                ...
                <div class="ui-grid-a"  >
                    <div class="ui-block-a">
                        <form action="patient-detail.jsp?id=${rs.rows[0].anagrafica_id}" method="post">
                            ...
                            <button type="submit" name="action" value="deletefamiliare" data-icon="delete" data-iconpos="left">Delete</button>
                        </form>
                    </div>
                    <div class="ui-block-b">
                        <a href="familiare-edit.jsp?id=${param.id}" data-role="button" data-icon="gear" data-iconpos="right">Edit</a>
                    </div>
                </div>
            </div>
