    ...
    <body>
        <div id="detail" data-role="page" data-add-back-btn="true">
            ...
            <div data-role="content">
                ...
                <ul data-role="listview" data-inset="true" data-theme="d">
                    <li data-role="list-divider">Patologie associate <a class="ui-li-count" style="font-size: 14px;padding: 0;" href="patologiec-add.jsp?anagrafica_id=${rs.rows[0].anagrafica_id}&terapie_id=${param.id}" data-role="button" data-theme="a" data-icon="plus" data-iconpos="notext">Inserimento nuovo esame</a> </li>
                    <c:choose>
                        <c:when test="${rspcon.rowCount eq 0}">
                            <li data-theme="d">Nessuna patologia associata.</li>
                        </c:when>
                        <c:otherwise>
                ...
                <div class="ui-grid-a"  >
                    <div class="ui-block-a">
                        <form action="patient-detail.jsp?id=${rs.rows[0].anagrafica_id}" method="post">
                            ...
                            <button type="submit" name="action" value="deleteterapia" data-icon="delete" data-iconpos="left" data-theme="e">Delete</button>
                        </form>
                    </div>
                    <div class="ui-block-b">
                        <a href="terapie-edit.jsp?id=${param.id}" data-role="button" data-icon="gear" data-iconpos="right" data-theme="b">Edit</a>
                    </div>
                </div>
            </div>
